...
//HW 2 Part 1: 60 Points
//Due: Wednesday 7th by 11:59 pm.
//Program Description: This program calcultes the asymptotic based
//runtime(theoretical) as well as the actual runtime of three main  
//sorting algrorithms. These include INSERTION-SORT, MERGE-SORT, 
//and QUICK-SORT. 
...
void insertRealTime(double arr[], int n, int nValue){
    ...
    //cout << "Insertion-Sort:\n n size: " << nValue << ", time: " << elapsed_secs <<endl;
}
...
void mergeRealTime(double arr[], int low, int high, int nValue){
    ...
    //cout << "Merge-Sort:\n n size: " << nValue << ", time: " << melapsed_secs <<endl;
}
...
void quickRealTime(double arr[], int low, int high, int nValue){
    ...
    //cout << "Quick-Sort:\n n size: " << nValue << ", time: " << qelapsed_secs <<endl;
}
